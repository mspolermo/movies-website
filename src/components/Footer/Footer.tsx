            ...
            <div className="footer__inner">
                <div className="footer__column">
                    ...
                    <ul className="footer__list">
                        <li className="footer__item">
                            <a href="https://corp.ivi.ru/" className="footer__link">О компании</a>
                        </li>
                        <li className="footer__item">
                ...
                <div className="footer__column">
                    ...
                    <ul className="footer__list">
                        ...
                        <li className="footer__item">
                            <a href="https://www.ivi.ru/cert" className="footer__link footer__link_activate">Активация сертификата</a>
                        </li>
                    </ul>
                </div>
                <div className="footer__column">
